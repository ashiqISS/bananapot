...
namespace bananapot\frontend\controllers;

use bananapot\frontend\Finder;
use bananapot\frontend\models\RegistrationForm;
use bananapot\frontend\models\ResendForm;
use bananapot\frontend\models\User;
use bananapot\frontend\traits\AjaxValidationTrait;
use bananapot\frontend\traits\EventTrait;
